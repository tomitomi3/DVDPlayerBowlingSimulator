...
namespace Demos.Demos
{
    ...
    public class BedsheetDemo : Demo
    {
        ...
        public unsafe override void Initialize(ContentArchive content, Camera camera)
        {
            ...
            Simulation = Simulation.Create(BufferPool, new ClothCallbacks() { Filters = filters }, new DemoPoseIntegratorCallbacks(new Vector3(0, -50, 0)), new PositionFirstTimestepper());
