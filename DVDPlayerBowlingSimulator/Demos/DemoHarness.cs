...
namespace Demos
{
    public class DemoHarness : IDisposable
    {
        ...
        public DemoHarness(GameLoop loop, ContentArchive content, Controls? controls = null)
        {
            this.loop = loop;
            this.content = content;

            //シミュレーションの変化をリングバッファに記録 default:512
            ...
            this.timingDisplayMode = TimingDisplayMode.Minimized;
