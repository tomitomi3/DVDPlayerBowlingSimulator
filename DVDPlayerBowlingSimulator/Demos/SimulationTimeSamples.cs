...
namespace Demos
{
    ...
    public class SimulationTimeSamples
    {
        ...
        public SimulationTimeSamples(int frameCapacity, BufferPool pool)
        {
            ...
            {
                Simulation.Add(0.0);
                PoseIntegrator.Add(0.0);
                Sleeper.Add(0.0);
                BroadPhaseUpdate.Add(0.0);
                CollisionTesting.Add(0.0);
                NarrowPhaseFlush.Add(0.0);
                Solver.Add(0.0);
                BodyOptimizer.Add(0.0);
                ConstraintOptimizer.Add(0.0);
                BatchCompressor.Add(0.0);
            }
        }
